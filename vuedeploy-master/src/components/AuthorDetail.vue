      ...
      <form @submit.prevent="action()">
        <div class="form-group mx-auto row">
          ...
          <div class="col-md-7">
            ...
            <div class="invalid-feedback" v-if="!$v.authorName.maxLength">
              book name have most
  ...
  methods: {
    ...
    createAuthor() {
      ...
      if (this.$v.$invalid) {
        ...
        console.log('tác giả');
        BaseRequest.post("author", { author_name: this.authorName,introduction: this.introduction })
          .then((response) => {
    ...
    updateAuthor() {
      ...
      if (this.$v.$invalid) {
        ...
        BaseRequest.put("author/" + this.id, author).then((response) => {
          console.log(response);
