    ...
    <div class="card-body">
      <form @submit.prevent="action()">
        <div class="form-group mx-auto row">
          <label for="book_name" class="col-form-label col-md-1"
        ...
        <div class="form-group mx-auto row">
          <label for="author" class="col-form-label col-md-1"
        ...
        <div class="form-group mx-auto row">
          <label for="categories" class="col-form-label col-md-1"
          ...
          <div class="col-md-7">
            ...
            <div class="invalid-feedback" v-if="!$v.categorySelect.required">
              category must be required
            </div>
          </div>
        </div>
        <div class="form-group mx-auto row">
          <label for="authors" class="col-form-label col-md-1"
          ...
          <div class="col-md-7">
            ...
            <div class="invalid-feedback" v-if="!$v.authorSelect.required">
              category must be required
            </div>
          </div>
        ...
        <div class="form-group mx-auto row">
          ...
          <div class="col-md-7">
            ...
            /> -->
            <select name="NXB" id="NXB" v-model = "NXB">
              <option value="" v-for="item in nxbList" :key="item">
        ...
        <div class="form-group mx-auto row">
          <label for="republic" class="col-form-label col-md-1"
        ...
        <div class="form-group mx-auto row">
          <label for="year" class="col-form-label col-md-1"
            >năm xuất bản:</label
          >
          <div class="col-md-7">
            <input
        ...
        <div class="form-group mx-auto row">
          <label for="price" class="col-form-label col-md-1"
          ...
          <form>
            <div class="modal-body">
              <div class="form-group row">
                <label for="author_name" class="col-md-3 col-form-label"
                  >Tên tác giả:</label
                >
                <div class="col-md-7">
                  <input
                  ...
                  />
                  <div class="valid-feedback">author name is valid</div>
                  <div class="invalid-feedback" v-if="!$v.authorName.required">
                    book name must be required
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    getNxbList(){
      BaseRequest.get("nxb/action/getNxbs").then(response =>{
