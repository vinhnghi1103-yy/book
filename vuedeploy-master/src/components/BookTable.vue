          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <router-link
                ...
                data-toggle="modal"
                ><i class="material-icons">&#xE147;</i>Add New Book</router-link
              >
        ...
        <table class="table table-striped table-hover">
          ...
          <tbody>
            <tr v-for="po in books" :key="po.id">
              ...
              <td>{{ po.id }}</td>
              <td>{{ po.book_name }}</td>
              <td><img :src="'http://localhost:8000/'+po.image.url" alt="" width="50px"></td>
              ...
              <td>
                ...
                >
                <router-link :to="`/book-added/${po.id}`" class="add-quatity"
                  ><i class="material-icons">&#xE148;</i></router-link
                >
              </td>
            </tr>
