<template>
  <div class="border">
    <div class="border-bottom p-4 ">
      ...
      <ul class="d-flex flex-column" style="padding-left:0px">
        <li v-for="cate in categories" :key="cate.id" style="list-style:none">
          <router-link
            :to="{ name: 'search-page', params: { categoryId: cate.id } }"
...
export default {
  mounted() {
    ...
    if(this.$route.params.categoryId == null && this.$route.name =="search-page" && Object.keys(this.$route.query).length===0){
