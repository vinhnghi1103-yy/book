<template>
  <div class="border">
    <div class="p-2">
      <div>
        <div class="row">
          <div class="col-4" style="font-size:20px">Sản phẩm mới nhất</div>
        </div>
        <div>
      ...
      <div>
        <div class="row">
          <div class="col-4" style="font-size:20px">Sản phẩm bán chạy</div>
        </div>
        <div>
      ...
      <div v-for="item in booksByCategoryId" :key="item.category.id">
        <div class="row">
          <div class="col-4" style="font-size:20px">{{item.category.category_name}}</div>
        </div>
        <div>
